...
# print(train_dataset[0].trajectories[0], train_dataset[0].trajectories[1], train_dataset[0].conditions[0])
# quit()
...
lr_scheduler = get_cosine_schedule_with_warmup(
    optimizer=optimizer,
    num_warmup_steps=(len(train_dataloader) * training_config.num_epochs) * 0.05,
